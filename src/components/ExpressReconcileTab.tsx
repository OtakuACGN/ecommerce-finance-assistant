...
export default function ExpressReconcileTab({
  ...
  const filterCounts = useMemo(() => {
    const empty = {
      ...
      multi: 0,
      highFee: 0,
    } as Record<ExpressFilter, number>;
    if (!result) return empty;
    const s = result.summary;
    let highFee = 0;
    for (const r of result.rows) {
      if (r.totalFee != null && (r.totalFee as number) >= highFeeThreshold) highFee += 1;
    }
    return {
  ...
  const filterCount = (k: ExpressFilter): number => filterCounts[k] || 0;
        ...
        <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-4 md:p-5">
          ...
          <div className="mt-4 grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <FileCard
              ...
              hint="含运单号、运费、预付面单的明细表（实际按运费，面单预付多退少补）"
            ...
            <>
              ...
              <div className="mt-3 grid grid-cols-2 sm:grid-cols-4 gap-2 text-sm">
                ...
                <div className="rounded-xl border border-sky-100 bg-sky-50 p-3">
                  ...
                  <div className="text-xs text-sky-700">账单实际运费</div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-4">
              ...
              <div className="flex items-center justify-between mb-3">
                ...
                <span className="text-[11px] text-slate-400">按实际运费</span>
